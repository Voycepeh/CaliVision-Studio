...
CaliVision Studio prioritizes durable authoring before hosted auth/database/storage exists. Local persistence prevents draft loss on refresh/reopen while preserving drill-first UX and internal file/package compatibility.
...
- **Export drill** = portable drill file for share/import/runtime usage.
