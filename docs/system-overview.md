...
- deterministic analysis runtime skeleton now exists in `src/lib/analysis/*` (frame scoring, temporal smoothing, event extraction, runner) for Upload Video and future live-analysis integration,
