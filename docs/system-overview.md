...
- **Studio web (this repo):** Home landing, Library, Drill Studio, Upload Video local-first analysis, Drill Exchange direction.
...
- brand-first homepage routing users into primary workflows,
